...
import { Navbar, NavbarBrand, Button, Col, FormGroup, Label, Input, Card, CardBody } from "reactstrap"
						...
						<div className="row">
							...
							<div className="row">
								<Col sm={{ size: 4, offset: 3}}>	
									<a href="/Schedule"><Button className="rounded-0 shadow-sm " block color="white">View your Schedule         </Button></a>
								</Col>		
							</div>
						</CardBody>
					</Card>
