...
const Doc2 = (props) => {
    ...
    useEffect(() => {
        ...
        const handleClick =()=>{
            axios.post("/doctors/appointment/605f89786ab3b02854353104", { appointments: { date: date, slots: { slot: state.time } }, docName: "Dr. Reshma Khan", email: currentUser.email }).then(response => console.log(response));
        }
                    ...
                    <div className="row">
                        <div className="col-12 col-sm-12">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-12 col-sm-12">
                                        <img top width="30%" src="/assets/images/2.jpg" class="img-rounded" alt="Doc1" />
                                    </div>
                                    <div className="col-12 col-sm-12 ">
                                        
                                        <h3>Dr. Reshma Khan</h3>
                                        <h5>M.B.B.S (ENT Specialist)</h5>
                                        <h5></h5>
                                        <h5></h5>
                                        <h4>
                                            From Government Medical College Gwallior 
                                        </h4>
                                    </div>
                                </div>
