...
const Doc3 = (props) => {
    ...
    useEffect(() => {
        ...
        const handleClick =()=>{
            axios.post("/doctors/appointment/605f89786ab3b02854353104", { appointments: { date: date, slots: { slot: state.time } }, docName: "Dr. Harvinder Singh", email: currentUser.email }).then(response => console.log(response));
        }
                ...
                <div className="row">
                    <div className="col-12 col-sm-12">
                        ...
                        <div className="row">
                            ...
                            <div className="col-12 col-sm-12">
                                <img top width="30%" src="/assets/images/3.jpg" class="img-rounded" alt="Doc3" />
                            </div>
                            <div className="col-12 col-sm-12 ">
